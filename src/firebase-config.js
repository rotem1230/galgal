...
import { getStorage } from "firebase/storage"; // הפעלתי את השורה הזו כדי לאפשר שימוש ב-Storage
...
const firebaseConfig = {
  ...
  storageBucket: "galbrother-1baff.appspot.com", // שיניתי את זה למבנה הנכון של Storage Bucket
