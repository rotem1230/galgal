...
import { Package, Archive, FileText, Users, Menu, X } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="flex min-h-[calc(100vh-56px)] lg:min-h-screen">
        {/* Sidebar for Desktop */}
        <div className="hidden lg:block w-64 bg-white border-l shadow-sm">
        ...
        >
          <div 
            className={cn(
              "fixed inset-y-0 right-0 w-64 bg-white shadow-xl transition-transform duration-200 transform",
